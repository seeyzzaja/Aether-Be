...
export type SessionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "refreshTokenHash" | "expiresAt" | "revokedAt" | "createdAt" | "updatedAt" | "deviceInfo" | "ipAddress", ExtArgs["result"]["session"]>;
