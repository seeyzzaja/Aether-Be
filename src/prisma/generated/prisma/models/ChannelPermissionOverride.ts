...
// @ts-nocheck 
/*
 * This file exports the `ChannelPermissionOverride` model and its related types.
 *
...
export type GetChannelPermissionOverrideAggregateType<T extends ChannelPermissionOverrideAggregateArgs> = {
      [P in keyof T & keyof AggregateChannelPermissionOverride]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateChannelPermissionOverride[P]>
    : Prisma.GetScalarType<T[P], AggregateChannelPermissionOverride[P]>
}
...
export type GetChannelPermissionOverrideGroupByPayload<T extends ChannelPermissionOverrideGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ChannelPermissionOverrideGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ChannelPermissionOverrideGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ChannelPermissionOverrideGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ChannelPermissionOverrideGroupByOutputType[P]>
      }
    >
  >
...
export type ChannelPermissionOverrideCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ChannelPermissionOverrideFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ChannelPermissionOverrideDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ChannelPermissionOverride'], meta: { name: 'ChannelPermissionOverride' } }
  /**
   ...
   * })
  **/
  count<T extends ChannelPermissionOverrideCountArgs>(
    args?: Prisma.Subset<T, ChannelPermissionOverrideCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ChannelPermissionOverrideCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ChannelPermissionOverrideGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ChannelPermissionOverrideGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetChannelPermissionOverrideGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
